...
def mostrar_manual_popup():
    ...
    **5. 🚨 ANEXO: PROTOCOLOS DE CORRECCIÓN DE ERRORES](#anexo-errores)
    ...
    <ul>
        ...
        <li><b>Aprobación de Horas Extras:</b> Cuando un evento termina de madrugada, las horas adicionales caen a una bandeja. RH debe aprobar explícitamente estas horas para que procedan al pago de nómina.</li>
    </ul>
    ...
    <ul>
        ...
        <li>Si el cliente aprueba la cotización, esta se "Promueve" a Orden de Producción, ahorrando doble captura.</li>
    </ul>
    ...
    <ul>
        <li>Levantamiento de reportes (ej. pérdida de llaves, faltas de respeto) en contra de empleados.</li>
        <li>Impacta en el Expediente de RH para futuras métricas de desempeño.</li>
    </ul>
    ...
    <ul>
        <li>Digitaliza los acuerdos tomados en las juntas de área.</li>
        <li>Asigna "To-Dos" (Tareas) al personal. Si no cumplen en la fecha prometida, el sistema arroja alertas de incumplimiento de objetivos.</li>
    </ul>

    <a href="#indice-general-interactivo">⬆️ Volver al Índice</a><hr>

    <h3 id="mod-analitica">4.4. 📈 Analítica / KPIs Gerenciales</h3>
    Panel de alto nivel (Dashboards visuales).
    <ul>
        <li>Rentabilidad de Eventos vs Presupuesto.</li>
        <li>Frecuencia de Mantenimiento de Vehículos y Equipos.</li>
        <li>Desempeño y puntualidad del personal según el Kiosco.</li>
    </ul>

    <a href="#indice-general-interactivo">⬆️ Volver al Índice</a><hr>

    <h3 id="anexo-errores">5. 🚨 ANEXO: PROTOCOLOS DE CORRECCIÓN DE ERRORES</h3>
    La regla de oro del sistema es: <i>"El que envía información, ya no puede modificarla"</i>. Esto protege contra alteraciones. Sin embargo, hay protocolos "Salvavidas" para Administración:
    <ul>
        ...
        <li><b>Personal olvidado en "Llamado":</b> Si el productor olvidó marcar la salida en la locación, el servidor VPRO detecta a las 19:00 hrs a la gente perdida y cierra sus turnos. Adicionalmente, RH puede editar sus bitácoras planas.</li>
        <li><b>Falso reporte de Equipo Dañado:</b> Si Bodega mandó algo a taller por error, el técnico solo debe buscar el equipo en su Expediente Clínico y marcarlo como "Falsa Alarma - Operativo", regresándolo al juego.</li>
    </ul>
